...
<div class="flex justify-center">
	<div class="alert alert-warning shadow-lg w-3/4">
		<div>
			<svg
...
<h1 class="text-center text-xl mt-1">Create an Account to Post a Job</h1>
...
<div class="flex justify-center items-center mt-8">
	<form on:submit={createUser} class="w-2/3 md:w-1/3">
